...
["_main","_memory","_getDisplayCanvasWidth","_getDisplayCanvasHeight","___asyncjs__loadString","___indirect_function_table","_fflush","___start_em_js","___stop_em_js","onRuntimeInitialized"].forEach((prop) => {
...
if (Module['locateFile']) {
  ...
  wasmBinaryFile = new URL('App.wasm', import.meta.url).href;
}
...
function getDisplayCanvasWidth() { return document.querySelector("#canvas").width; }
function getDisplayCanvasHeight() { return document.querySelector("#canvas").height; }
function __asyncjs__loadString(path) { return Asyncify.handleAsync(async () => { const dataPath = UTF8ToString(path); const data = await fetch(dataPath).then(function(res) { return res.text(); }); const length = lengthBytesUTF8(data); const ptr = _malloc(length); stringToUTF8(data, ptr, length); return ptr; }); }
  ...
  var _wgpuQueueOnSubmittedWorkDone = function(queueId,signalValue_low, signalValue_high,callback,userdata) {
    var signalValue = convertI32PairToI53Checked(signalValue_low, signalValue_high);;
      ...
      queue["onSubmittedWorkDone"]().then(() => {
        ...
        callUserCallback(() => {
          ((a1, a2) => dynCall_vii.apply(null, [callback, a1, a2]))(0, userdata);
        });
      }, () => {
        
        callUserCallback(() => {
          ((a1, a2) => dynCall_vii.apply(null, [callback, a1, a2]))(1, userdata);
        });
      });
    ;
  };
...
var wasmImports = {
  ...
  /** @export */
  __asyncjs__loadString: __asyncjs__loadString,
  /** @export */
  ...
  fd_write: _fd_write,
  /** @export */
  getDisplayCanvasHeight: getDisplayCanvasHeight,
  /** @export */
  getDisplayCanvasWidth: getDisplayCanvasWidth,
  /** @export */
...
var ___start_em_js = Module['___start_em_js'] = 92052;
var ___stop_em_js = Module['___stop_em_js'] = 92469;
